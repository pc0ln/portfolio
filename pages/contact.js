    ...
    return (
        <div className='h-[80%] lg:w-[80%] lg:mx-auto'>
            ...
            <div className='grid grid-cols-3 h-full'>
                <div className='border-2 border-slate-800 text-slate-200'>
                    <div className='text-center h-1/3 flex justify-center flex-col select-none'>
                        ...
                        <p>Check me out <a href='https://www.linkedin.com/in/phoenix-coln/' className='text-cyan-400'>here</a></p>
                    </div>
                    <div className='text-center h-1/3 flex justify-center flex-col select-none'>
                        <img src='/github.svg' className='h-8 w-8 mx-auto'/>
                        <h1 className='font-semibold'>Github</h1>
                        <p>Check me out <a href='https://github.com/pc0ln' className='text-cyan-400'>here</a></p>
                    </div>
                    <div className='text-center h-1/3 flex justify-center flex-col select-none'>
